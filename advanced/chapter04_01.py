...
# 1.런타임 초기화 가능
# 2.변수 등에 할당 가능
# 3.함수 인수 전달 가능 sorted(key=len())
# 4.함수 결과로 반환 가능 return fucntion()
...
print('EX2-4 -', list(map(var_func, range(1,6)))) # map은 돌리고 돌리고 라는 의미
...
from inspect import signature # 함수의 인자를 조사하는 것

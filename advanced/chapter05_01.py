...
tl2 = tl1
tl3 = list(tl1) # 새로운 객체를 사용하고 싶을 때는 데이터 타입을 명시적 형변환을 이용하면 새 객체(id값이 다른)가 생성됨.
...
print('EX4-8 -', tl1)
print('EX4-9 -', tl2) # 튜플 재 할당(객체 새로 생성) # 튜플부분만 id값이 바뀜 즉, 새로 생성된 것임. 그러므로 리스트안에 튜플을 넣으면 불안정함.
print('EX4-10 -', tl3)
# print(id(tl1[2]))

...
print('EX1-2 -', hash(t1))
# print('EX1-3 -', hash(t2)) # 가변형인 리스트가 튜플안에 들어가있기 때문에 변할 수 있는 값이 있으므로 해시를 사용할 수 없음.
...
with open('C:/python_advanced/python_advanced/resources/test1.csv', 'r', encoding='UTF-8') as f:
    temp = csv.reader(f)
    # Header Skip
    next(temp)
    # 변환
